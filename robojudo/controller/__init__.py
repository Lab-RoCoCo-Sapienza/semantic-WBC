...
ctrl_registry.add("PolicyGuiCtrl", ".policy_gui_ctrl")
ctrl_registry.add("ShazamFileWatchCtrl", ".shazam_file_watch_ctrl")
ctrl_registry.add("MusicCommandSocketCtrl", ".music_command_socket_ctrl")
ctrl_registry.add("MusicCommandSocketClientCtrl", ".music_command_socket_client_ctrl")
